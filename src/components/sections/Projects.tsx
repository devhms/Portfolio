...
const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    description: 'High-performance WebGL configurator with real-time material swapping and physics-based rendering.',
  ...
  },
  {
    ...
    description: 'Distributed editor using Yjs and WebSockets with conflict-free replicated data types (CRDTs).',
